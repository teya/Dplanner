...
<div class="projects">
	<a id="create_projects" class="button_1 float_left" href="<?php echo get_site_url(); ?>/manage-projects/projects/add-project/">+ Add Project</a>
...
<?php 
	...
	$projects = $wpdb->get_results("SELECT * FROM {$table_name_project} ORDER BY project_name ASC");
		...
		<div class="ajax_parent">
			...
			<?php
				foreach($projects as $project){
					if($project->project_client_id == $client->ID){
			...
			<div class="display_section delete_ajax_<?php echo $project->ID; ?>">
				<div id="display_note_<?php echo $project->ID; ?>" class="display_note">
					<div class="display_list" onclick="window.open('<?php echo get_site_url(); ?>/manage-projects/project-information/?id=<?php echo $project->ID ?>');">
						<a class="button_2 display_button" href="<?php echo get_site_url(); ?>/manage-projects/edit-project/?editID=<?php echo $project->ID ?>">Edit</a>
