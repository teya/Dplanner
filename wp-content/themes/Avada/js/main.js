...
jQuery(document).ready(function($) {
  ...
  //   );
	...
	jQuery(document).ready(function(){
		jQuery(document).on("click", "h5.toggle" , function() {
		if(jQuery(this).parents('.accordian').length >=1){
			var accordian = jQuery(this).parents('.accordian');
		...
		jQuery(document).on("mouseleave", "h5.toggle" , function() {
	...
	// jQuery(document).on("mouseenter", "h5.toggle", function() {
