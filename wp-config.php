<?php
define('WP_HOME','http://localhost/dplan');
define('WP_SITEURL','http://localhost/dplan');
...
// define( 'WPCACHEHOME', '/home/seoweb91/public_html/dplan/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('WP_MEMORY_LIMIT', '256M');
//define('WP_CACHE', true); //Added by WP-Cache Manager
define('DB_NAME', 'dplan_db');
